...
TOKEN=`cat /home//pushNotifications/token.dat`
...
pico2wave -w /home//pushNotifications/tmp/pipe.wav "${QUESTION}" | tee /home//pushNotifications/pico2wav.wav | sox - -c 1 -r 16000 -e signed -b 16 -t wav - >> /home//pushNotifications/multipart_body.txt
